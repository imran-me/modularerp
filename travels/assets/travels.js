...
(function (w) {
  ...
  Travels.drawRevenue = function (canvasId) {
    ...
    g.addColorStop(0, 'rgba(201,162,39,0.35)'); g.addColorStop(1, 'rgba(201,162,39,0.02)');
    new w.Chart(el, {
      type: 'line',
      data: { labels: d.labels, datasets: [
        { label: 'Revenue', data: d.revenue, borderColor: '#C9A227', backgroundColor: g, fill: true, tension: 0.4, borderWidth: 2, pointRadius: 0, pointHoverRadius: 5 },
        { label: 'Profit', data: d.profit, borderColor: '#34d399', backgroundColor: 'transparent', tension: 0.4, borderWidth: 2, pointRadius: 0, borderDash: [5,4] }
      ]},
      options: {
  ...
  Travels.drawMix = function (canvasId) {
    ...
    new w.Chart(el, {
      ...
      data: { labels: d.labels, datasets: [{ data: d.data,
        backgroundColor: ['#C9A227','#2f6bff','#34d399','#a855f7','#f472b6'], borderColor: 'rgba(0,0,0,0.2)', borderWidth: 2 }] },
