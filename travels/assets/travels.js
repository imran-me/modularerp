...
(function (w) {
  ...
  Travels.drawRevenue = function (canvasId) {
    ...
    g.addColorStop(0, 'rgba(37,145,217,0.38)'); g.addColorStop(1, 'rgba(37,145,217,0.02)');   // ocean-blue fill
    new w.Chart(el, {
      type: 'line',
      data: { labels: d.labels, datasets: [
        { label: 'Revenue', data: d.revenue, borderColor: '#2591D9', backgroundColor: g, fill: true, tension: 0.4, borderWidth: 2, pointRadius: 0, pointHoverRadius: 5 },
        { label: 'Profit', data: d.profit, borderColor: '#8FD0F7', backgroundColor: 'transparent', tension: 0.4, borderWidth: 2, pointRadius: 0, borderDash: [5,4] }   // sky-blue
      ]},
      options: {
  ...
  Travels.drawMix = function (canvasId) {
    ...
    new w.Chart(el, {
      ...
      data: { labels: d.labels, datasets: [{ data: d.data,
        backgroundColor: ['#2591D9','#1E4F9C','#38BDF8','#0EA5E9','#60A5FA'], borderColor: 'rgba(0,0,0,0.2)', borderWidth: 2 }] },   // blue family
