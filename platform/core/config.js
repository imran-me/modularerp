...
(function (EPAL) {
  ...
  var GROUP_MODULES = [
    ...
    m('master-accounts','Master Accounts',      'safe2',         { desc:'Group accounting desk — expenses, categories, budgets, reports, journals, schedules, party types, master payroll — with a company switcher.',
        subs:[['expenses','All Expenses'],['categories','Categories'],['budget','Budget Setup'],['report','Expense Report'],
