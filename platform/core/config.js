...
(function (EPAL) {
  ...
  var TRAVELS_MODULES = [
    ...
    m('payroll',         'Payroll',          'cash-coin', { desc:'Salary template, monthly run, loans, payslips & advances (tabs at the top — no sub-menu).' }),
  ...
  var WOODART_MODULES = [
    ...
    m('payroll',      'Payroll',          'cash-coin', { desc:'Salary run, loans, payslips & advances (tabs at the top).' }),
