  ...
  EPAL.view('*/reports', { render: function (ctx) {
    ...
    function htmlDoc(title, bodyHtml) {
      return '<!doctype html><html><head><meta charset="utf-8"><title>' + title + '</title><style>' +
        ...
        'h1{margin:0;font-size:24px}h2{border-bottom:2px solid #1A43BF;padding-bottom:6px;margin-top:26px;font-size:15px}' +
        ...
        '.head{display:flex;justify-content:space-between;align-items:center;border-bottom:3px solid #1A43BF;padding-bottom:12px}' +
        '.muted{color:#666;font-size:12.5px}.brand{font-weight:800;color:#1A43BF;font-size:14px}</style></head><body>' +
