...
(function (EPAL) {
  ...
  function downloadProfile(e) {
    ...
    var html = '<!doctype html><html><head><meta charset="utf-8"><title>' + e.name + ' — Profile</title>' +
      ...
      'h1{margin:0}h2{border-bottom:2px solid #2591D9;padding-bottom:6px;margin-top:28px;font-size:16px}' +
      ...
      '.head{display:flex;justify-content:space-between;align-items:center;border-bottom:3px solid #2591D9;padding-bottom:14px}' +
      '.muted{color:#666;font-size:13px}.brand{font-weight:800;color:#2591D9}</style></head><body>' +
