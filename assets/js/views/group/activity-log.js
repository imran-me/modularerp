...
(function (EPAL) {
  ...
  var ACTIONS = {
    ...
    post:       { label:'Posted',     icon:'journal-text',       color:'#3B6FA8' },
    login:      { label:'Signed in',  icon:'box-arrow-in-right', color:'#3B6FA8' },
    logout:     { label:'Signed out', icon:'box-arrow-right',    color:'#8b93a7' },
    approve:    { label:'Approved',   icon:'patch-check-fill',   color:'#3B6FA8' },
