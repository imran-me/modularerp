...
(function (EPAL) {
  ...
  var ACTIONS = {
    ...
    post:       { label:'Posted',     icon:'journal-text',       color:'#2591D9' },
    login:      { label:'Signed in',  icon:'box-arrow-in-right', color:'#2591D9' },
    logout:     { label:'Signed out', icon:'box-arrow-right',    color:'#8b93a7' },
    approve:    { label:'Approved',   icon:'patch-check-fill',   color:'#2591D9' },
