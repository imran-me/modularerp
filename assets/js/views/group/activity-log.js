...
(function (EPAL) {
  ...
  var ACTIONS = {
    ...
    post:       { label:'Posted',     icon:'journal-text',       color:'#c8a24a' },
    login:      { label:'Signed in',  icon:'box-arrow-in-right', color:'#c8a24a' },
    logout:     { label:'Signed out', icon:'box-arrow-right',    color:'#8b93a7' },
    approve:    { label:'Approved',   icon:'patch-check-fill',   color:'#c8a24a' },
