...
function navBtn(label, active, onClick) { var b = frag('nav-btn'); if (active) b.classList.add('active'); b.textContent = label; b.addEventListener('click', onClick); return b; }
  ...
  function sectionNav(sub) {
    ...
    SECTIONS.forEach(function (s) {
      nav.appendChild(navBtn(s[1], active === s[0], function () { EPAL.router.navigate('travels/air-ticketing' + (s[0] === 'overview' ? '' : '/' + s[0])); }));
    });
    return nav;
  }
  ...
  function overview(page) {
    ...
    page.appendChild(kgrid('div.kpi-grid.kpi-slim.kpi-onerow.stagger', null, [
  ...
  function drawStock(host) {
    ...
    host.appendChild(kgrid('div.kpi-grid.kpi-slim.kpi-onerow.stagger', null, [
  ...
  function manageSales(page) {
    ...
    var kpis = kgrid('div.kpi-grid'); page.appendChild(kpis);
  ...
  function airlineDetail(a, refresh) {
    ...
    body.appendChild(el('div.card', null, [ el('div.card-body', null, [ el('div.flex.items-center.gap-2.flex-wrap', null, [
      ...
      actions ]) ]) ]));
    body.appendChild(kgrid('div.kpi-grid.kpi-compact.stagger', null, [
  ...
  function bspView(page) {
    ...
    page.appendChild(kgrid('div.kpi-grid', null, [
  ...
  function refundsView(page) {
    ...
    function draw() {
      ...
      host.appendChild(kgrid('div.kpi-grid', null, [
  ...
  function kpi(label, value, icon, onClick, delta) {
    ...
    var icoEl = slot(n, 'ico');
    icoEl.innerHTML = '<i class="bi bi-' + icon + '"></i>';
    if (delta) {
      icoEl.parentNode.insertBefore(el('span', { title:'last 30 days vs prior 30', style:{ marginLeft:'auto', fontSize:'10.5px', fontWeight:'700', whiteSpace:'nowrap', color: delta.dir==='up'?'#23c17e':'#f0506e' }, html:(delta.dir==='up'?'▲ ':'▼ ')+delta.txt }), icoEl);
      icoEl.style.marginLeft = '8px';
    }
  ...
  function bspCountdown(page){
    ...
    var grid = kgrid('div.kpi-grid.kpi-compact', { style:{ cursor:'pointer' }, onclick:function(){ EPAL.router.navigate('travels/air-ticketing/bsp'); } }, [
